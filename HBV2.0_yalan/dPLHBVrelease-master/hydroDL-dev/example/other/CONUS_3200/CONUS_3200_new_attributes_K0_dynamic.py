...
tdRep = [1,2,7, 13]  # When using dynamic parameters, this list defines which parameters to set as dynamic
...
rootOut = "/projects/mhpi/yxs275/model/"+'/dPL_local_daymet_new_attr_NSEloss_fast_low_dynamic/'
