...
BATCH_SIZE = 50  ## equvalent to 100
RHO = 365
saveEPOCH = 1
alpha = 0.25
HIDDENSIZE1 = 64
...
ETMod = True
Nfea1 = 2  # should be 13 when setting ETMod=True. 12 when ETMod=False

Nfea2 = 14  # should be 13 when setting ETMod=True. 12 when ETMod=False
HIDDENSIZE2 = 1024*4 
Nmul2 = 4
...
drinv2 = 0.5
model_name= 'waterlossv10'   ###Which water loss formula to use
...
rootOut = "/projects/mhpi/yxs275/model/water_loss_model/"+'/dPL_local_daymet_new_attr_water_loss_v6v10_multiGPU'
