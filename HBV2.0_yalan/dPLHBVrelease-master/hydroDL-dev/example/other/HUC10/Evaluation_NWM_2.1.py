...
selected_Basin = np.load(data_folder_new+"selected_Basin_matched_v3.npy")
selected_GAGE = np.load(data_folder_new+"selected_GAGE_matched_v3.npy")

Insmall_list = []
lat_selected = []
lon_selected = []
meanflowrate_selected = []
evaluateTime = pd.date_range('1981-01-01', f'2019-12-01', freq='d')
count = 0
...
evaDict = [statError(predAll[:,:], obsAll[:,:])]
evaDictLst = evaDict
