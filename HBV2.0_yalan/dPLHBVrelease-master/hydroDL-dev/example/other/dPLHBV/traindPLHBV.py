...
rootOut = rootDatabase + "output/record_16_4hour/"
...
##Adapt for Amir to use 531 basins
...
# xtrain_new  = forcTuple[0][SubInd,:,:]
# ztrain_new = forcTuple[1][SubInd,:,:]
# forcTuple = (xtrain_new,ztrain_new)
# yTrainIn = yTrainIn[SubInd,:,:]
# attrs = attrs[SubInd,:]
