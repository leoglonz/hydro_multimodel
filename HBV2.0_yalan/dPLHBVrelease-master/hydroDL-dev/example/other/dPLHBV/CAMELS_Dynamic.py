...
data = np.load("/projects/mhpi/yxs275/Data/CAMELSData/Camels_inputs.npy")
streamflow_data = np.load("/projects/mhpi/yxs275/Data/CAMELSData/Camels_outputs.npy")

forcing_norm = np.load("/projects/mhpi/yxs275/Data/CAMELSData/Camels_inputs_norm.npy")

attri_norm = np.load("/projects/mhpi/yxs275/Data/CAMELSData/Camels_attr_norm.npy")
...
rootOut = "/projects/mhpi/yxs275/Adjoint_output/"+'/record_16_sequential/'
